    ...
    <div className="page-stack">
      <section className="page-hero">
        <div className="page-hero-content">
          <div>
            <div className="muted-kicker text-white-50">Task Workspace</div>
            <h2 className="page-hero-title">{isAdmin ? "Team Daily Tasks" : "My Daily Tasks"}</h2>
            <p className="page-hero-text">
              Create tasks, review progress, and keep the day moving with quick filters for status, date, and ownership.
            </p>
          </div>
          <div className="page-hero-actions">
            ...
            <span className="hero-badge">{tasks.length} tasks</span>
          </div>
        </div>
      </section>
      ...
      <div className={!formVisible ? "page-grid-task-creation" : "page-grid"}>
        <div className="content-card">
          <div className="mb-3">
            <h3 className="section-title mb-1">{isAdmin ? "Task List" : "Assigned Tasks"}</h3>
        ...
        {formVisible ? (
          <div className="content-card sticky-card">
            <div className="d-flex justify-content-between align-items-center mb-3">
              <div>
                <h2 className="section-title mb-1">{editingId ? "Update Task" : "Create Task"}</h2>
                <p className="text-muted mb-0">Keep every task clear, dated, and easy for the team to act on.</p>
              </div>
